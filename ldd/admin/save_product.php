...
if($act=="add")
{
$sql="insert into product(name,price,content,pic,c_id) values('$name','$price','$content','$pic','$category')";
mysql_query($sql);
...
{
$id=$_POST["id"];
$sql="update product set name='$name',c_id='$category',pic='$pic',price='$price',content='$content' where product_id='$id'";
mysql_query($sql);
